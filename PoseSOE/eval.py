...
from models.model_pnsoe import PoseSOE
...
parser.add_argument('--model', type=str, default='PoseSOE',
                    help='PointNetPose or PointNetPlusPlusPose')
parser.add_argument('--seed', type=int, default=20, metavar='S',
                    help='random seed (default: 20)')
parser.add_argument('--log_dir', default='PoseSOE-NCLT-step-1000-20220913/',
