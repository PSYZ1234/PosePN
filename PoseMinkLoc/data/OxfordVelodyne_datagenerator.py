...
from utils.pose_util import process_poses, filter_overflow_ts, ds_pc
...
class RobotCar(data.Dataset):
    def __init__(self, data_path, train=True, valid=False, augmentation=[], num_points=4096, real=False,
        ...
        for seq in seqs:
            ...
            pcs_all.extend([osp.join(seq_dir, 'velodyne_left', '{:d}.bin'.format(t)) for t in ts[seq]])
