...
parser.add_argument('--batch_size', type=int, default=200,
                    help='Batch Size during training [default: pn:100|pn++:200]')
...
parser.add_argument("--decay_step", type=float, default=2000,
                    help="decay step for learning rate, default: 1000")
parser.add_argument('--optimizer', default='adam',
                    help='adam or momentum [default: adam]')
parser.add_argument('--seed', type=int, default=20, metavar='S',
                    help='random seed (default: 20)')
parser.add_argument('--log_dir', default='PoseMinkLoc-NCLT-step-2000-20220915/',
...
parser.add_argument('--trajectory', default='full6',
                    help='name of figure [default: full6/7/8/9]')
...
def train_one_epoch(model, train_loader, scheduler, epoch, train_writer, loss, device):
    ...
    for _,input_dict in enumerate(train_loader):
        ...
        train_pose  = input_dict['T_gt'].to(device)
        gt_t        = train_pose[..., :3]  # [B, 3]
        gt_q        = train_pose[..., 3:]  # [B, 3]
