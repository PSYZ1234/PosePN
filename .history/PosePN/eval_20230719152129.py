...
parser.add_argument('--log_dir', default='/home/data/yss/PR/Code_previous2/results_20220303/memory/',
...
parser.add_argument('--resume_model', type=str, default='pn++-oxford-k-4/checkpoint_epoch66.tar',
